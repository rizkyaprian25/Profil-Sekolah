  ...
  return (
    <main>
      <header className="page-header">
        <h1 className="page-title">Komite Sekolah</h1>
        <p>Halaman ini sedang dalam tahap pengembangan.</p>
      </header>
      <section className="page-content">
        <h2>Komite Sekolah</h2>
        <p style={{ marginTop: '20px', color: '#475569' }}>
          Ini adalah teks dummy (sementara) untuk halaman Komite Sekolah. Nantinya Anda dapat mengganti teks ini dengan informasi yang sebenarnya mengenai SMPN 3 Cibungbulang. 
        </p>
