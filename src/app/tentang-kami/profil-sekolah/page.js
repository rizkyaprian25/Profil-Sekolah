    ...
    <main>
      ...
      <section className="page-content">
        ...
        <p style={{ marginTop: '20px', color: '#475569' }}>
          Ini adalah teks dummy (sementara) untuk halaman Profil Sekolah. Nantinya Anda dapat mengganti teks ini dengan informasi yang sebenarnya mengenai SMPN 3 Cibungbulang. 
        </p>
